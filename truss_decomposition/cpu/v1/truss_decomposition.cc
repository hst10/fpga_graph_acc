...
{
#ifdef HLS
#pragma HLS INTERFACE m_axi port=neighbor_list depth=32 offset=slave bundle=neighbor_list
#pragma HLS INTERFACE m_axi port=offset_list depth=32 offset=slave bundle=offset_list
#pragma HLS INTERFACE m_axi port=edge_list depth=32 offset=slave bundle=edge_list
...
#pragma HLS pipeline
                    ...
                    else
                    {
                        if ((edge_node_p != 0) && (edge_node_q != 0))
                        {
                            ...
                            decrease_tc(target_node_a, target_node_b, edge_list, edge_tc, hash_edge2idx, num_edges); 
